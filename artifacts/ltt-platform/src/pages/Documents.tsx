    ...
    <div className="p-3 sm:p-6 space-y-5">
      <div className="flex items-start justify-between gap-3 flex-wrap">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold text-foreground">إدارة التراخيص والمستندات</h1>
          <p className="text-muted-foreground text-xs sm:text-sm mt-1">
            متابعة الصلاحيات والوثائق القانونية لجميع الوكلاء ونقاط البيع
          </p>
        </div>
        <div className="flex gap-2 flex-wrap shrink-0">
          <button onClick={() => setEditing("new")} className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg text-sm hover:bg-primary/90 shadow font-semibold">
            <Plus size={15} /> مستند جديد
          </button>
          <button onClick={exportToCsv} className="inline-flex items-center gap-2 px-3 py-2 border border-border rounded-lg text-xs sm:text-sm hover:bg-muted">
